...
class BlockChain extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.setState({ ref: `https://ropsten.etherscan.io/tx/${this.state.trxUsed}` })
            .then(response => response.json())
        // console.log('asseytid' + assetid);
                        ...
                        <div className='flex'>
                            <div className='form center pa4 br3 shadow-5'>
                                <fieldset id="land_details" className="ba b--transparent ph0 mh0">
                                    ...
                                    <div className="mt3">
                                        <label className="db fw6 lh-copy f6" htmlFor="block-hash">Block Hash</label>
                                    ...
                                    <div className="mt3">
                                        <label className="db fw6 lh-copy f6" htmlFor="block-number">Block Number </label>
                                        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"
                                            type="number"
                                    ...
                                    <div className="mt3">
                                        <label className="db fw6 lh-copy f6" htmlFor="address">Contract Address</label>
                                        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"
                                            type="text"
                                    ...
                                    <div className="mt3">
                                        <label className="db fw6 lh-copy f6" htmlFor="number">Gas Used</label>
                                        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"
                                            type="number"
                                    ...
                                    <div className="mt3">
                                        <label className="db fw6 lh-copy f6" htmlFor="number">Transaction USed</label>
                                        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"
                                            type="text"
                                    ...
                                    <div className="mt3">
                                        <label className="db fw6 lh-copy f6" htmlFor="number">Ether Scan </label>
                                        <Nav.Link className="logo" href={`https://ropsten.etherscan.io/tx/${this.state.trxUsed}`} >Transaction</Nav.Link>
                                        {/* <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" 
                                    ...
                                    <button className='w-30 grow f4 link ph3 pv2 dib white bg-light-purple'
                                        onClick={(e) => { this.componentDidMount(e) }} >Go to Home</button>
                                </fieldset>
                            </div>
                        </div>
                    </div>
